...
function Project() {
  return (
    <div id='projects' className='items-center font-winky  bg-linear-to-br from-[#00585E] to-[#95ebd4] px-10 text-center'>
      ...
      <div className='border border-white  rounded-3xl shadow-black shadow-sm px-3 py-3 bg-[#00585E]'>
        ...
        <div >
          ...
          <a
  href="https://github.com/SAUGAT2060/Amazon_Clone.git"
  target="_blank"
  rel="noopener noreferrer"
  className='rounded-3xl bg-[#00585E] px-5 py-3 border border-white text-white flex items-center gap-2 m-auto ' 
>
...
<a
  href="https://github.com/SAUGAT2060/Cat_Api_App.git"
  target="_blank"
  rel="noopener noreferrer"
  className='rounded-3xl bg-[#00585E] px-5 py-3 border border-white text-white flex items-center gap-2 m-auto ' 
>
  ...
  Github
      ...
      <div className='border border-white  rounded-3xl shadow-black shadow-sm px-3 py-3 bg-[#00585E]'>
       ...
       <a
  href="https://github.com/SAUGAT2060/React/tree/main/12MegaBlog"
  target="_blank"
  rel="noopener noreferrer"
  className='rounded-3xl bg-[#00585E] px-5 py-3 border border-white text-white flex items-center gap-2 m-auto ' 
>
